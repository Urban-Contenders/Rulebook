...
# Urban Riga Open #6 – General Information and rules

#### Dear reader,

Welcome to the **Urban Riga Open #6**!  
...
“Urban Riga Open #6” tournament is organized by Potion Agency SIA (40203488582).

“Urban Riga Open #6”  is a Tier 2 Valve Regional Standings (VRS) Ranked Counter-Strike 2 tournament with an open LAN format. This event provides a grassroots competitive experience in the heart of Riga, welcoming any team ready to compete.

As a VRS-ranked event, Urban Riga Open #6 adheres to Valve’s rules for ranked tournaments, ensuring a fair structure for invites and qualifiers. The Valve Regional Standings (VRS) is the official ranking system used by Valve to gauge team performance and determine invitations for CS2 events. This rulebook outlines all regulations, format details, and expectations for teams participating in Urban Riga Open.
