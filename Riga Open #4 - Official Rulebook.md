...
#### 1.10.1 Reseeding
__a)__  If any dropouts occur more than 15 days _(before March 19th, 2026, 00:00 EET)_ before the event's start date, the tournament will be reseeded. If the dropout happens within 15 days ( of the tournament’s start, the replacement team will inherit the dropped team’s position in the tournament. However, they will be assigned the lowest available seed in that stage for the purposes of the map veto. All teams seeded below the dropped team will move up one spot in the seeding for the map veto.

__b)__ If a team withdraws up-to 7 days _(before March 27th, 2026, 00:00 EET)_ before the event start date, it will be replaced by the first available regional team (EE, LV, LT) from the waiting list.

__c)__ If a team withdraws 7 days or less _(Later than March 27th, 2026, 00:00 EET)_ before the event start date, and no replacement team is available, the organizer may award walkovers for the withdrawn team’s matches.
